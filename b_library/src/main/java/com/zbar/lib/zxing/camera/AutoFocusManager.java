...
package com.zbar.lib.zxing.camera;
...
import com.zbar.lib.zxing.common.Runnable;
import com.zbar.lib.zxing.config.Config;
...
final class AutoFocusManager implements Camera.AutoFocusCallback {
	...
	AutoFocusManager(Context context, Camera camera) {
		...
		this.useAutoFocus = sharedPrefs.getBoolean(Config.KEY_AUTO_FOCUS, true)
