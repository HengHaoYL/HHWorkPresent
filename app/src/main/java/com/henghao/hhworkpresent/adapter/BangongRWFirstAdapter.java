...
public class BangongRWFirstAdapter extends ArrayAdapter<AppGridEntity> {
    ...
    public BangongRWFirstAdapter(ActivityFragmentSupport activityFragment, List<AppGridEntity> list) {
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        BangongRWFirstAdapter.HodlerView mHodlerView = null;
        if (convertView == null) {
            mHodlerView = new BangongRWFirstAdapter.HodlerView();
            ...
            mHodlerView = (BangongRWFirstAdapter.HodlerView) convertView.getTag();
        }
     ...
     * @param position
     */
    public void viewOnClick(BangongRWFirstAdapter.HodlerView mHodlerView, View convertView, final int position){
