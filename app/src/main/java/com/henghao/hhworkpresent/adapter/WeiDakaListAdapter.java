...
public class WeiDakaListAdapter extends ArrayAdapter<WeiQiandaoEntity> {
    ...
    public WeiDakaListAdapter(ActivityFragmentSupport activityFragment, List<WeiQiandaoEntity> mList){
    ...
    public View getView(final int position, View convertView, ViewGroup parent) {
        ...
        mHodlerView.tv_state.setText(getItem(position).getNoSignIn());
