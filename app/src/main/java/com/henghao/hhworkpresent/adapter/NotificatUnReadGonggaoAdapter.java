...
public class NotificatUnReadGonggaoAdapter extends ArrayAdapter<GonggaoEntity> {
    ...
    public NotificatUnReadGonggaoAdapter(ActivityFragmentSupport activityFragment, List<GonggaoEntity> mList){
    ...
    public View getView(final int position, View convertView, ViewGroup parent) {
        NotificatUnReadGonggaoAdapter.HodlerView mHodlerView = null;
        if (convertView == null) {
    ...
    //        mHodlerView.imageView = (ImageView) convertView.findViewById(R.id.msg_imageview);
            ...
            mHodlerView = (NotificatUnReadGonggaoAdapter.HodlerView) convertView.getTag();
        }
