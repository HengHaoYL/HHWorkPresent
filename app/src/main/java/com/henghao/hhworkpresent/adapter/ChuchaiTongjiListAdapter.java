...
public class ChuchaiTongjiListAdapter extends ArrayAdapter<ChuchaiTongjiEntity> {
    ...
    public ChuchaiTongjiListAdapter(ActivityFragmentSupport activityFragment, List<ChuchaiTongjiEntity> mList) {
    ...
    public View getView(final int position, View convertView, ViewGroup parent) {
        ...
        mHodlerView.tv_state.setText(getItem(position).getEvection());
