...
public class QingjiaTongjiaListAdapter extends ArrayAdapter<QingjiaTongjiEntity> {
    ...
    public QingjiaTongjiaListAdapter(ActivityFragmentSupport activityFragment, List<QingjiaTongjiEntity> mList){
    ...
    public View getView(final int position, View convertView, ViewGroup parent) {
        ...
        mHodlerView.tv_state.setText(getItem(position).getLeave());
