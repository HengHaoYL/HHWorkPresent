 ...
 * @since [产品/模块版本]
 */
public class ItemGridAdapter extends ArrayAdapter<AppGridEntity> {
    ...
    public ItemGridAdapter(ActivityFragmentSupport activityFragment, List<AppGridEntity> list) {
