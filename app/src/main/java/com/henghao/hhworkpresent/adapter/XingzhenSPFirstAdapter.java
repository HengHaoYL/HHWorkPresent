...
public class XingzhenSPFirstAdapter extends ArrayAdapter<AppGridEntity> {
    ...
    public XingzhenSPFirstAdapter(ActivityFragmentSupport activityFragment, List<AppGridEntity> list) {
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        XingzhenSPFirstAdapter.HodlerView mHodlerView = null;
        if (convertView == null) {
            mHodlerView = new XingzhenSPFirstAdapter.HodlerView();
            ...
            mHodlerView = (XingzhenSPFirstAdapter.HodlerView) convertView.getTag();
        }
     ...
     * @param position
     */
    public void viewOnClick(XingzhenSPFirstAdapter.HodlerView mHodlerView, View convertView, final int position){
