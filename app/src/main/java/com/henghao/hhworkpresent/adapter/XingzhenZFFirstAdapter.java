...
public class XingzhenZFFirstAdapter extends ArrayAdapter<AppGridEntity> {
    ...
    public XingzhenZFFirstAdapter(ActivityFragmentSupport activityFragment, List<AppGridEntity> list) {
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        XingzhenZFFirstAdapter.HodlerView mHodlerView = null;
        if (convertView == null) {
            mHodlerView = new XingzhenZFFirstAdapter.HodlerView();
            ...
            mHodlerView = (XingzhenZFFirstAdapter.HodlerView) convertView.getTag();
        }
     ...
     * @param position
     */
    public void viewOnClick(XingzhenZFFirstAdapter.HodlerView mHodlerView, View convertView, final int position){
