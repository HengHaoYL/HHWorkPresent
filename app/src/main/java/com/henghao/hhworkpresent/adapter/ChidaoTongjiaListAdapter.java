...
public class ChidaoTongjiaListAdapter extends ArrayAdapter<ChidaoTongjiaEntity> {
    ...
    public ChidaoTongjiaListAdapter(ActivityFragmentSupport activityFragment, List<ChidaoTongjiaEntity> mList){
    ...
    public View getView(final int position, View convertView, ViewGroup parent) {
        ...
        mHodlerView.tv_state.setText(getItem(position).getClockInTime());
