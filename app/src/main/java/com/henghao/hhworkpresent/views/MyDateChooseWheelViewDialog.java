...
import com.henghao.hhworkpresent.views.adapter.AbstractWheelTextAdapter;
import com.henghao.hhworkpresent.views.listener.OnWheelChangedListener;
import com.henghao.hhworkpresent.views.listener.OnWheelScrollListener;
...
public class MyDateChooseWheelViewDialog extends Dialog implements View.OnClickListener {
    //控件
    private MyWheelView mYearWheelView;
    private MyWheelView mDateWheelView;
    ...
    public MyDateChooseWheelViewDialog(Context context,DateChooseInterface dateChooseInterface) {
        super(context);
...
//                mDateCalendarTextView.setText(" " + arry_date.get(wheel.getCurrentItem()));
    ...
    private void initView() {
        ...
        mYearWheelView = (MyWheelView) view.findViewById(R.id.year_wv);
        mDateWheelView = (MyWheelView) view.findViewById(R.id.date_wv);
        mHourWheelView = (MyWheelView) view.findViewById(R.id.hour_wv);
        mMinuteWheelView = (MyWheelView) view.findViewById(R.id.minute_wv);
