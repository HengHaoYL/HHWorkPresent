...
public class XCDropDownListView extends LinearLayout {
    ...
    private ArrayList<JianchaTeamEntity> dataList = new ArrayList<JianchaTeamEntity>();
    private View mView;
     ...
     * @param list
     */
    public void setItemsData(ArrayList<JianchaTeamEntity> list) {
        dataList = list;
    ...
    class XCDropDownListAdapter extends BaseAdapter {
        ...
        Context mContext;
        ArrayList<JianchaTeamEntity> mData;
        LayoutInflater inflater;

        public XCDropDownListAdapter(Context ctx, ArrayList<JianchaTeamEntity> data) {
            mContext = ctx;
            mData = data;
        ...
        public View getView(final int position, View convertView, ViewGroup parent) {
            ...
            // 设置数据
            listItemView.tv.setText(mData.get(position).getTroopname());
            final String text = mData.get(position).getTroopname().toString();
    ...
    public interface XCDropDownListViewListener{
        void getItemData(JianchaTeamEntity jianchaTeamEntity);
    }
