...
public class KaoqingQuekaDetailActivity extends ActivityFragmentSupport {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        this.mActivityFragmentView.viewMain(R.layout.activity_kaoqingquekadetail);
    ...
    private void httpRequestKaoqingZaotuiofDate() {
        ...
        String request_url = ProtocolUrl.ROOT_URL + "/"+ ProtocolUrl.APP_QUERY_DAY_OF_QUEKA;
