...
public class ChebanwenjianActivity extends ActivityFragmentSupport {
    ...
    public void init() {
        ...
        progressWebView.loadUrl(WorkflowUrl.WORKFLOW_VIEW_URL+sqliteDBUtils.getUsername()+WorkflowUrl.CHEBANWENJIAN_VIEWID);
    }
