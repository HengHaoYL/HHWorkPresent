...
public class ChushenActivity extends ActivityFragmentSupport {
    ...
    public void init() {
        ...
        progressWebView.loadUrl("http://222.85.156.33:8082/hz7/horizon/workflow/support/open.wf?loginName="+sqliteDBUtils.getUsername()+"&flowId=sichu(chucishenqing)");
    }
