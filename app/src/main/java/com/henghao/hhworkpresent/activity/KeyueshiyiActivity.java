...
public class KeyueshiyiActivity extends ActivityFragmentSupport {
    ...
    public void init() {
        ...
        progressWebView.loadUrl(WorkflowUrl.WORKFLOW_VIEW_URL +sqliteDBUtils.getUsername()+ WorkflowUrl.KEYUESHIYI_VIEWID);
    }
