...
public class YiyueshiyiActivity extends ActivityFragmentSupport {
    ...
    public void init() {
        ...
        progressWebView.loadUrl(WorkflowUrl.WORKFLOW_VIEW_URL + sqliteDBUtils.getUsername()+ WorkflowUrl.YIYUESHIYI_VIEWID);
    }
