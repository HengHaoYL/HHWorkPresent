...
public class DaiyueshiyiActivity extends ActivityFragmentSupport {
    ...
    public void init() {
        ...
        progressWebView.loadUrl(WorkflowUrl.WORKFLOW_VIEW_URL+sqliteDBUtils.getUsername()+WorkflowUrl.DAIYUESHIYI_VIEWID);
    }
