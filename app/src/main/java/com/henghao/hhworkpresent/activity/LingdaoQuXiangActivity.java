...
/**
 * Created by bryanrady on 2017/6/6.
 */

public class LingdaoQuXiangActivity extends ActivityFragmentSupport {
    ...
    public void init() {
        ...
        progressWebView.loadUrl(WorkflowUrl.WORKFLOW_VIEW_URL+sqliteDBUtils.getUsername()+WorkflowUrl.LINGDAOQUXIANG_VIEWID);
    }
