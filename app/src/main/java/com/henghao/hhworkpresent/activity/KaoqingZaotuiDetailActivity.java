...
public class KaoqingZaotuiDetailActivity extends ActivityFragmentSupport {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        this.mActivityFragmentView.viewMain(R.layout.activity_kaoqingzaotuidetail);
    ...
    public void onResume() {
        super.onResume();
        httpRequestKaoqingZaotuiofDate();
    }
    ...
    private void httpRequestKaoqingZaotuiofDate() {
        ...
        String request_url = ProtocolUrl.ROOT_URL + "/"+ ProtocolUrl.APP_QUERY_DAY_OF_ZAOTUI;
